...
* ONLY PC
* [Download](https://github.com/Holastor/Blade-and-Soul-2-Localization/releases/tag/0.7.3) Latest Release (B2_Data_00002.pak);
...
* In LocalOption.json find "language":1" and change it to "language":7" for English Language or "language":8" for Chinese Language;
* And that's it you have english language!;

## Source-Install
* ONLY PC
* Download Source code (zip) [Download](https://github.com/Holastor/Blade-and-Soul-2-Localization/releases/tag/0.7.3)
...
## Mobile-Install
* ONLY Android
* [Download](https://github.com/Holastor/Blade-and-Soul-2-Localization/releases/tag/0.7.0_M) Latest Release (patch.32.com.ncsoft.bns219.obb);
